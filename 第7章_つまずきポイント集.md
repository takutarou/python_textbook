...
→ これは不整合状態！
→ VS Codeでスクリプトを実行すると、base環境で実行される
```

**解決：**
VS Code右下の表示とターミナルのプロンプトを一致させる
...
**Mac/Linux：**
```
/Users/username/Documents/python_projects/myproject/data.csv
```
...
**推奨：** 方法1（`/`を使う）が最もシンプルで、Mac/Linuxでも動く
